...
<span class="yearpopup">  <a alt="yearly temperature" title="yearly temperature" href="<?php echo $chartsource ;?>/yearlytemperature.php" data-featherlight="iframe" > <?php echo $menucharticonpage?> <?php echo date('Y');?> </a>
<a alt="yearly dew point" title="yearly dew point" href="<?php echo $chartsource ;?>/yearlydewpoint.php" data-featherlight="iframe" > <?php echo '| Dew';?> </a></span>
<span class="monthpopup"> <a alt="monthly temperature" title="monthly temperature" href="<?php echo $chartsource ;?>/monthlytemperature.php" data-featherlight="iframe" > <?php echo $menucharticonpage?> <?php echo strftime(" %b") ;?> </a>
<a alt="monthly dew point" title="monthly dew point" href="<?php echo $chartsource ;?>/monthlydewpoint.php" data-featherlight="iframe" > <?php echo '| Dew' ;?> </a></span>
...
<span class="todaypopup"> <a alt="today wind direction" title="today wind direction" href="<?php echo $chartsource ;?>/todaywinddirection.php" data-featherlight="iframe" ><?php echo $menucharticonpage.$lang['Winddirection'] ?></a></span>
      </div>
...
<span class="todaypopup"> <a alt="today rainfall" title="today rainfall" href="<?php echo $chartsource ;?>/todayrainfall.php" data-featherlight="iframe" ><?php echo $menucharticonpage?> <?php echo $lang['Today']; ?> </a></span>
  ...
  <div class="weather-item"><div class="chartforecast" >
  <span class="yearpopup">
<?php if ($position12=='webcamsmall.php' || $position12=='indoortemperature.php' || $position12=='moonphase.php'){echo'<a alt="Webcam " title="Webcam " href="cam.php" data-featherlight="iframe">'. $webcamicon. ' Live Webcam </a></span><span class="yearpopup"> <a alt="Indoor Guide" title="Indoor Guide" href="homeindoor.php" data-featherlight="iframe">'. $chartinfo. ' Indoor Guide </a></span><span class="yearpopup"> <a alt="Moon Info" title="Moon Info" href="mooninfo.php" data-featherlight="iframe">'. $chartinfo. ' Moon Info </a></span>';}?>
...
<?php if ($position12=='eq.php') {echo ' <a alt="Earthquakes Worldwide" title="Earthquakes Worldwide" href="eqlist.php" data-featherlight="iframe">'. $chartinfo. " Worldwide Earthquakes </a></span>";}?>
 ...
 <!--position last module for homeweatherstation template-->
  <div class="weather-item"><div class="chartforecast" >
  <span class="yearpopup">
<?php if ($positionlastmodule=='webcamsmall.php' || $positionlastmodule=='indoortemperature.php' || $positionlastmodule=='moonphase.php'){echo'<a alt="Webcam " title="Webcam " href="cam.php" data-featherlight="iframe">'. $webcamicon. ' Live Webcam </a></span><span class="yearpopup"> <a alt="Indoor Guide" title="Indoor Guide" href="homeindoor.php" data-featherlight="iframe">'. $chartinfo. ' Indoor Guide </a></span><span class="yearpopup"> <a alt="Moon Info" title="Moon Info" href="mooninfo.php" data-featherlight="iframe">'. $chartinfo. ' Moon Info </a></span>';}?>
...
</div><span class='moduletitle'><?php echo $positionlastmoduletitle?></span>
<div id="dldata"></div>
</div></div>
